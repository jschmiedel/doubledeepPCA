function_dGestimation_plot_globalparameter_relationships = function(models_file,print_file) {
  load(file=paste0(models_file,".Rdata"))
  ...
  p=ggpairs(dt)
  ggsave(plot = p,filename = paste0(print_file,"_globalpar.pdf"),width=10,height=10)
